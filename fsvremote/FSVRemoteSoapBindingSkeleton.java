...
public class FSVRemoteSoapBindingSkeleton implements fsvremote.FSVRemoteSoapPort, org.apache.axis.wsdl.Skeleton {
    private fsvremote.FSVRemoteSoapPort impl;
    ...
    */
    ...
    public FSVRemoteSoapBindingSkeleton() {
        this.impl = new fsvremote.FSVRemoteSoapBindingImpl();
    }

    public FSVRemoteSoapBindingSkeleton(fsvremote.FSVRemoteSoapPort impl) {
        this.impl = impl;
    }
