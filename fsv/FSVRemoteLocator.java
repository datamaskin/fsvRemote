...
public class FSVRemoteLocator extends org.apache.axis.client.Service implements fsv.FSVRemote {
    ...
    private java.lang.String FSVRemoteSoapPort_address = "http://TECH-PC13:8080/axis/services/FSVRemote.WSDL";
    ...
    public fsv.FSVRemoteSoapPort getFSVRemoteSoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fsv.FSVRemoteSoapBindingStub _stub = new fsv.FSVRemoteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fsv.FSVRemoteSoapPort.class.isAssignableFrom(serviceEndpointInterface)) {
                fsv.FSVRemoteSoapBindingStub _stub = new fsv.FSVRemoteSoapBindingStub(new java.net.URL(FSVRemoteSoapPort_address), this);
                _stub.setPortName(getFSVRemoteSoapPortWSDDServiceName());
                return _stub;
            }
        }
